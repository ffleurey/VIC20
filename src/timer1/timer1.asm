...
mainloop:
    ...
    printBinary($9114, $5D+22*4-4, '1', '0', 0)
    printBinary($9124, $5D+22*4+5, '1', '0', 0)
...
irq:        // The cpu state has been saved by the kernal
    ...
    // Check if it is a via 1 interrupt
    bit $911d
    bmi irq_via1
...
irq_via1:
    bit  $9114  // Read the low bytes of the counter to clear the interrupt flag
